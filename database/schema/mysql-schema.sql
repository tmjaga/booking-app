...
CREATE TABLE `bookings` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `bookings_id_room_id_customer_id_unique` (`id`,`room_id`,`customer_id`),
...
CREATE TABLE `customers` (
  ...
  KEY `customers_name_index` (`customer_name`),
...
CREATE TABLE `room_types` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `room_types_type_unique` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2024_04_24_055150_create_room_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2024_04_24_055155_create_rooms_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2024_04_24_091622_create_customers_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2024_04_24_093356_create_bookings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2024_04_24_094145_create_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2024_04_26_085739_change_customers_table_rename_name_field',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2024_04_26_091306_change_customers_table_change_phone_number_field_type',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2024_05_01_194226_create_jobs_table',1);
